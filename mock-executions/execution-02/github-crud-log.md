...
- Read: fetched `github-crud-canary.txt` from GitHub through the GitHub connector and verified `state=create`.
...
The canary file is intentionally absent from the final tree. This log is the durable evidence for the CRUD smoke test.
